...
namespace Rendering
{
	...
	public:
		ModelFromFile(Game& game, Camera& camera, const std::string modelFilename, const std::wstring texturize);
		ModelFromFile(Game& game, Camera& camera, const std::string modelFilename, const std::wstring modelDes, int modelValue, const std::wstring texturize);
		~ModelFromFile();
