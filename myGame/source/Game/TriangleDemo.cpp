...
namespace Rendering
{
    ...
    TriangleDemo::TriangleDemo(Game& game, Camera& camera)
        : DrawableGameComponent(game, camera),
          ...
          mInputLayout(nullptr), mWorldMatrix(MatrixHelper::Identity), mVertexBuffer(nullptr), mIndexBuffer(nullptr), mTextureShaderResourceView(nullptr), mColorTextureVariable(nullptr),mAngle(0.0f)
    {
    }
    ...
    shaderFlags |= D3DCOMPILE_SKIP_OPTIMIZATION;
		...
		TextureMappingVertex vertices[] =
		{
					...
					*/
					/*Bird
					BasicEffectVertex(XMFLOAT4(-1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
					BasicEffectVertex(XMFLOAT4(-0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
					BasicEffectVertex(XMFLOAT4(0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue

					BasicEffectVertex(XMFLOAT4(-1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
					BasicEffectVertex(XMFLOAT4(0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
					BasicEffectVertex(XMFLOAT4(1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
					//Neck
					BasicEffectVertex(XMFLOAT4(-1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
					BasicEffectVertex(XMFLOAT4(-1.2f, 2.2f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
					BasicEffectVertex(XMFLOAT4(-0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
					//Beak
					BasicEffectVertex(XMFLOAT4(-1.2f, 2.2f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
					BasicEffectVertex(XMFLOAT4(-1.25f, 1.6f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
					BasicEffectVertex(XMFLOAT4(-1.8f, 1.5f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue

					//Tail
					BasicEffectVertex(XMFLOAT4(0.8f, 1.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
					BasicEffectVertex(XMFLOAT4(1.8f, 2.6f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
					BasicEffectVertex(XMFLOAT4(1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue

					//Wings
					BasicEffectVertex(XMFLOAT4(-1.5, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
					BasicEffectVertex(XMFLOAT4(0.0f, 2.5f, 2.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
					BasicEffectVertex(XMFLOAT4(1.5f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
					...
					*/
					//The ground
					//BasicEffectVertex(XMFLOAT4(-3.0f, 0.0f, 3.0f, 1.0f), XMFLOAT4(0.0f, 0.5f,0.0f,1.0f)),//V0
					//BasicEffectVertex(XMFLOAT4(3.0f, 0.0f, 3.0f, 1.0f), XMFLOAT4(0.0f, 0.5f, 0.0f, 1.0f)),//V1
					//BasicEffectVertex(XMFLOAT4(3.0f, 0.0f, -3.0f, 1.0f), XMFLOAT4(0.0f, 0.5f, 0.0f, 1.0f)),//V2
					//BasicEffectVertex(XMFLOAT4(-3.0f, 0.0f, -3.0f, 1.0f), XMFLOAT4(0.0f, 0.5f, 0.0f, 1.0f)),//V3
